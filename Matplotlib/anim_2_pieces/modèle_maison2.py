...
mur_sud1 = def_mur(10, constru['Parpaing'], 0, 0, 110, 0, 0, 'horizontale')
mur_nord1 = def_mur(10, constru['Parpaing'], 0, 0, 110, 50, 50, 'horizontale')
mur_est1 = def_mur(10, constru['Parpaing'], 1, 110, 110, 50, 0, 'verticale')
mur_ouest1 = def_mur(10, constru['Parpaing'], 0, 0, 0, 50, 0, 'verticale')
paroi = def_mur(10, constru['Parpaing'], 0, 57, 57, 50, 0, 'verticale')
Maison2 = [mur_sud1, mur_nord1, mur_est1, mur_ouest1, paroi]
...
Maison4 = [mur_ouest2, mur_est2, mur_nord2, mur_sud2, paroi_hor2, paroi_vert2]
