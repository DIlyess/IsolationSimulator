...
def animation_diff(lamb, rho, c, epaisseur, hauteur, T_haut, T_bas, T_droite, T_gauche, T_int_mur, T_int_piece, x_piece, y_piece, T_chauffage=30, chauffage=0):
...
chauffage = False
T_chauffage = 30
animation_diff(lamb, rho, c, epaisseur, hauteur, T_haut, T_bas, T_droite,
               T_gauche, T_int_mur, T_int_piece, x_piece, y_piece, T_chauffage, chauffage)
